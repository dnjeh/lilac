      ...
      <div className="flex gap-10 flex-col-reverse lg:flex-row">
        <div className="flex-1 order-2 my-auto">
          ...
          <h3 className="text-slate-700 dark:text-zinc-400">
            : {context.host}, {context.timestemp_start} -{" "}
            {context.timestemp_end}
          </h3>
        ...
        <div
          className={cn(
            "hidden md:flex items-center justify-center h-80 p-1 border-[1px] dark:border-black rounded-lg dark:bg-[#0C0C0C] select-none order-2",
