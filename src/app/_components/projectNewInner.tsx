...
const ProjectNewInner = ({image, dark_image, project_type, key2}: ProjectNewBannerType) => {
  ...
  return (
    ...
    <li className="border-[3px] w-full h-[24dvw] sm:h-36 rounded-xl xs:rounded-2xl shadow-inner shadow-stone-200 dark:shadow-zinc-800 relative border-stone-200 dark:border-zinc-800 bg-no-repeat bg-center bg-[length:calc(60%)] hover:bg-[length:calc(70%)] cursor-pointer"
      style={{
